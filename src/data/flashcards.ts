...
export const creaturesCards: Flashcard[] = [
  {
    ...
    letter: 'A',
    word: 'Angel',
    rhyme: 'Angels soar up high, watching from the sky',
    definition: 'A helpful creature with wings that protects others',
    color: 'from-yellow-200 to-orange-300',
    imageUrl: '/images/art_webp/c-a_angel.webp'
  },
  {
    id: 'c-b',
    letter: 'B',
    word: 'Beast',
    rhyme: 'Beasts are big and strong, stomping all day long',
    definition: 'A wild animal with great power',
    color: 'from-green-300 to-emerald-400',
    imageUrl: '/images/art_webp/c-b_beast.webp'
  },
  {
    id: 'c-c',
    letter: 'C',
    word: 'Cat',
    rhyme: 'Clever cats can pounce, quick as they announce',
    definition: 'A swift and sneaky feline friend',
    color: 'from-amber-200 to-yellow-300',
    imageUrl: '/images/art_webp/c-c_cat.webp'
  },
  {
    id: 'c-d',
    letter: 'D',
    word: 'Dragon',
    rhyme: 'Dragons breathe out flame, flying is their game',
    definition: 'A magical flying lizard that breathes fire',
    color: 'from-red-400 to-orange-500',
    imageUrl: '/images/art_webp/c-d_dragon.webp'
  },
  {
    id: 'c-e',
    letter: 'E',
    word: 'Elf',
    rhyme: 'Elves live in the trees, dancing in the breeze',
    definition: 'A graceful forest creature with pointy ears',
    color: 'from-green-200 to-lime-300',
    imageUrl: '/images/art_webp/c-e_elf.webp'
  },
  {
    id: 'c-f',
    letter: 'F',
    word: 'Faerie',
    rhyme: 'Faeries fly so light, sparkling in the night',
    definition: 'A tiny magical being with shimmering wings',
    color: 'from-blue-200 to-cyan-300',
    imageUrl: '/images/art_webp/c-f_faerie.webp'
  },
  {
    id: 'c-g',
    letter: 'G',
  ...
  },
  {
    ...
    letter: 'H',
    word: 'Hydra',
    rhyme: 'Hydras grow more heads, from their water beds',
    definition: 'A creature with many snake-like heads',
    color: 'from-teal-300 to-emerald-400',
    imageUrl: '/images/art_webp/c-h_hydra.webp'
  },
  {
    id: 'c-i',
    letter: 'I',
    word: 'Imp',
    rhyme: 'Imps are small and sly, zooming as they fly',
    definition: 'A mischievous little creature',
    color: 'from-purple-300 to-pink-300',
    imageUrl: '/images/art_webp/c-i_imp.webp'
  },
  {
    id: 'c-j',
    letter: 'J',
    word: 'Jellyfish',
    rhyme: 'Jellyfish drift and glow, floating to and fro',
    definition: 'A see-through water creature that floats',
    color: 'from-cyan-200 to-blue-300',
    imageUrl: '/images/art_webp/c-j_jellyfish.webp'
  },
  {
    id: 'c-k',
    letter: 'K',
  ...
  },
  {
    ...
    letter: 'L',
    word: 'Lion',
    rhyme: 'Lions roar with pride, walking side by side',
    definition: 'A powerful cat with a golden mane',
    color: 'from-amber-300 to-orange-400',
    imageUrl: '/images/art_webp/c-l_lion.webp'
  },
  {
    id: 'c-m',
    letter: 'M',
    word: 'Merfolk',
    rhyme: 'Merfolk swim and play, in the waves all day',
    definition: 'People who live in the ocean with fish tails',
    color: 'from-blue-300 to-teal-400',
    imageUrl: '/images/art_webp/c-m_merfolk.webp'
  },
  {
    id: 'c-n',
    letter: 'N',
  ...
  },
  {
    ...
    letter: 'O',
    word: 'Ox',
    rhyme: 'Oxen plow the ground, making not a sound',
    definition: 'A strong animal that helps with work',
    color: 'from-stone-300 to-amber-400',
    imageUrl: '/images/art_webp/c-o_ox.webp'
  },
  {
    id: 'c-p',
    letter: 'P',
    word: 'Phoenix',
    rhyme: 'Phoenix burns so bright, rising in new light',
    definition: 'A magical bird that comes back to life from fire',
    color: 'from-orange-400 to-red-500',
    imageUrl: '/images/art_webp/c-p_phoenix.webp'
  },
  {
    id: 'c-q',
    letter: 'Q',
  ...
  },
  {
    ...
    letter: 'R',
    word: 'Rat',
    rhyme: 'Rats are quick and small, scurrying through the hall',
    definition: 'A clever little creature with a long tail',
    color: 'from-gray-300 to-stone-400',
    imageUrl: '/images/art_webp/c-r_rat.webp'
  },
  {
    id: 'c-s',
    letter: 'S',
    word: 'Spider',
    rhyme: 'Spiders spin their webs, on their silky threads',
    definition: 'A creature with eight legs that makes webs',
    color: 'from-slate-400 to-zinc-500',
    imageUrl: '/images/art_webp/c-s_spider.webp'
  },
  {
    id: 'c-t',
    letter: 'T',
    word: 'Turtle',
    rhyme: 'Turtles take their time, in their shells so fine',
    definition: 'A slow creature with a hard shell home',
    color: 'from-green-300 to-teal-400',
    imageUrl: '/images/art_webp/c-t_turtle.webp'
  },
  {
    id: 'c-u',
    letter: 'U',
    word: 'Unicorn',
    rhyme: 'Unicorns are rare, with magic in the air',
    definition: 'A beautiful horse with a magical horn',
    color: 'from-pink-200 to-purple-300',
    imageUrl: '/images/art_webp/c-u_unicorn.webp'
  },
  {
    id: 'c-v',
    letter: 'V',
    word: 'Vampire',
    rhyme: 'Vampires fly at night, gone by morning light',
    definition: 'A creature that sleeps during the day',
    color: 'from-red-300 to-rose-400',
    imageUrl: '/images/art_webp/c-v_vampire.webp'
  },
  {
    id: 'c-w',
    letter: 'W',
    word: 'Wolf',
    rhyme: 'Wolves run in a pack, through forests dark and black',
    definition: 'A wild dog that hunts with friends',
    color: 'from-gray-400 to-slate-500',
    imageUrl: '/images/art_webp/c-w_wolf.webp'
  },
  {
    id: 'c-x',
    letter: 'X',
    word: 'Xantid',
    rhyme: 'Xantids buzz around, without a single sound',
    definition: 'A magical insect that flies quietly',
    color: 'from-lime-300 to-green-400',
    imageUrl: '/images/art_webp/c-x_xantid.webp'
  },
  {
    id: 'c-y',
    letter: 'Y',
    word: 'Yeti',
    rhyme: 'Yetis in the snow, where cold winds blow',
    definition: 'A big furry creature from snowy mountains',
    color: 'from-cyan-200 to-blue-300',
    imageUrl: '/images/art_webp/c-y_yeti.webp'
  },
  {
    id: 'c-z',
    letter: 'Z',
    word: 'Zombie',
    rhyme: 'Zombies walk so slow, shambling to and fro',
    definition: 'A creature that moves in a sleepy way',
