...
export const creaturesCards: Flashcard[] = [
  { id: 'c-a', letter: 'A', word: 'Angel', rhyme: 'Angels soar up high, watching from the sky', definition: 'A helpful creature with wings that protects others', color: 'from-yellow-200 to-orange-300' },
  { id: 'c-b', letter: 'B', word: 'Beast', rhyme: 'Beasts are big and strong, stomping all day long', definition: 'A wild animal with great power', color: 'from-green-300 to-emerald-400' },
  { id: 'c-c', letter: 'C', word: 'Cat', rhyme: 'Clever cats can pounce, quick as they announce', definition: 'A swift and sneaky feline friend', color: 'from-amber-200 to-yellow-300' },
  { id: 'c-d', letter: 'D', word: 'Dragon', rhyme: 'Dragons breathe out flame, flying is their game', definition: 'A magical flying lizard that breathes fire', color: 'from-red-400 to-orange-500' },
  { id: 'c-e', letter: 'E', word: 'Elf', rhyme: 'Elves live in the trees, dancing in the breeze', definition: 'A graceful forest creature with pointy ears', color: 'from-green-200 to-lime-300' },
  { id: 'c-f', letter: 'F', word: 'Faerie', rhyme: 'Faeries fly so light, sparkling in the night', definition: 'A tiny magical being with shimmering wings', color: 'from-blue-200 to-cyan-300' },
  { id: 'c-g', letter: 'G', word: 'Giant', rhyme: 'Giants stand so tall, biggest of them all', definition: 'An enormous person who towers above', color: 'from-stone-300 to-gray-400' },
  { id: 'c-h', letter: 'H', word: 'Hydra', rhyme: 'Hydras grow more heads, from their water beds', definition: 'A creature with many snake-like heads', color: 'from-teal-300 to-emerald-400' },
  { id: 'c-i', letter: 'I', word: 'Imp', rhyme: 'Imps are small and sly, zooming as they fly', definition: 'A mischievous little creature', color: 'from-purple-300 to-pink-300' },
  { id: 'c-j', letter: 'J', word: 'Jellyfish', rhyme: 'Jellyfish drift and glow, floating to and fro', definition: 'A see-through water creature that floats', color: 'from-cyan-200 to-blue-300' },
  { id: 'c-k', letter: 'K', word: 'Knight', rhyme: 'Knights in armor bright, ready for a fight', definition: 'A brave warrior who protects others', color: 'from-slate-300 to-zinc-400' },
  { id: 'c-l', letter: 'L', word: 'Lion', rhyme: 'Lions roar with pride, walking side by side', definition: 'A powerful cat with a golden mane', color: 'from-amber-300 to-orange-400' },
  { id: 'c-m', letter: 'M', word: 'Merfolk', rhyme: 'Merfolk swim and play, in the waves all day', definition: 'People who live in the ocean with fish tails', color: 'from-blue-300 to-teal-400' },
  { id: 'c-n', letter: 'N', word: 'Nighthawk', rhyme: 'Nighthawks swoop and dive, keeping dreams alive', definition: 'A bird that flies in the dark', color: 'from-slate-400 to-gray-500' },
  { id: 'c-o', letter: 'O', word: 'Ox', rhyme: 'Oxen plow the ground, making not a sound', definition: 'A strong animal that helps with work', color: 'from-stone-300 to-amber-400' },
  { id: 'c-p', letter: 'P', word: 'Phoenix', rhyme: 'Phoenix burns so bright, rising in new light', definition: 'A magical bird that comes back to life from fire', color: 'from-orange-400 to-red-500' },
  ...
  { id: 'c-r', letter: 'R', word: 'Rat', rhyme: 'Rats are quick and small, scurrying through the hall', definition: 'A clever little creature with a long tail', color: 'from-gray-300 to-stone-400' },
  { id: 'c-s', letter: 'S', word: 'Spider', rhyme: 'Spiders spin their webs, on their silky threads', definition: 'A creature with eight legs that makes webs', color: 'from-slate-400 to-zinc-500' },
  { id: 'c-t', letter: 'T', word: 'Turtle', rhyme: 'Turtles take their time, in their shells so fine', definition: 'A slow creature with a hard shell home', color: 'from-green-300 to-teal-400' },
  { id: 'c-u', letter: 'U', word: 'Unicorn', rhyme: 'Unicorns are rare, with magic in the air', definition: 'A beautiful horse with a magical horn', color: 'from-pink-200 to-purple-300' },
  { id: 'c-v', letter: 'V', word: 'Vampire', rhyme: 'Vampires fly at night, gone by morning light', definition: 'A creature that sleeps during the day', color: 'from-red-300 to-rose-400' },
  { id: 'c-w', letter: 'W', word: 'Wolf', rhyme: 'Wolves run in a pack, through forests dark and black', definition: 'A wild dog that hunts with friends', color: 'from-gray-400 to-slate-500' },
  { id: 'c-x', letter: 'X', word: 'Xantid', rhyme: 'Xantids buzz around, without a single sound', definition: 'A magical insect that flies quietly', color: 'from-lime-300 to-green-400' },
  { id: 'c-y', letter: 'Y', word: 'Yeti', rhyme: 'Yetis in the snow, where cold winds blow', definition: 'A big furry creature from snowy mountains', color: 'from-cyan-200 to-blue-300' },
  { id: 'c-z', letter: 'Z', word: 'Zombie', rhyme: 'Zombies walk so slow, shambling to and fro', definition: 'A creature that moves in a sleepy way', color: 'from-gray-400 to-stone-500' },
];
